        ...
        <div class="container">
            ...
            <div class="product-detail">
                <div class="product-detail-image">
                    <?php 
                    $image_path = $product['image'] && file_exists('images/products/' . $product['image']) 
                        ? 'images/products/' . htmlspecialchars($product['image'])
                        : 'images/placeholder.png';
                    ?>
                    <img src="<?php echo $image_path; ?>" alt="<?php echo htmlspecialchars($product['name']); ?>" style="width: 100%; height: 100%; object-fit: cover; border-radius: 12px;">
