                    ...
                    <div class="cart-items">
                        ...
                        <div class="cart-item">
                            <div class="cart-item-image">
                                ...
                                <?php 
                                $image_path = $item['image'] && file_exists('images/products/' . $item['image']) 
                                    ? 'images/products/' . htmlspecialchars($item['image'])
                                    : 'images/placeholder.png';
                                ?>
                                <img src="<?php echo $image_path; ?>" alt="<?php echo htmlspecialchars($item['name']); ?>" style="width: 100%; height: 100%; object-fit: cover; border-radius: 8px;">
                            </div>
